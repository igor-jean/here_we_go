...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <label for="adresse" class="form-label">Adresse :</label>
            ...
            <p class="heure-date"> La description </p>
            <div class="row">
              <div class="col-md-12">
              <label for="description_courte" class="form-label mt-3">Description courte :</label>
              ...
              <div class="mb-12">
                <label for="description_longue" class="form-label mt-3">Description longue :</label>
                ...
                <div class="col-6">
              <label for="id_categorie" class="form-label mt-3">Choisir une categorie :</label>
            ...
            <p class="heure-date">La réservation</p>
        <div class="row">
            <div class="col-md-6">
