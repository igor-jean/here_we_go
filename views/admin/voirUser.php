...
<div class="container">
    <img src="imgUploaded/<?php echo $utilisateur->getAvatar();?>" alt="Avatar de l'utilisateur" class="mb-3" style="width: 100px;<?php if($premium) echo "border: 5px solid gold; border-radius : 100%"?>">
    <form action="/here_we_go/modification_utilisateur" method="POST">
        ...
        <div class="mb-3">
            <label for="mail" class="form-label">Mail<span class="red-star"> *</span>:</label><br>
            <input type="text" class="form-control" id="mail" name="mail" value="<?php echo $utilisateur->getMail(); ?>"><br>
        </div>
        <div class="mb-3">
            <label for="nom" class="form-label">Nom<span class="red-star"> *</span>:</label><br>
            <input type="text" class="form-control" id="nom" name="nom" value="<?php echo $utilisateur->getNom(); ?>"><br>
        </div>
        <div class="mb-3">
            <label for="prenom" class="form-label">Prénom<span class="red-star"> *</span>:</label><br>
        ...
        <div class="mb-3">
            <label for="ville" class="form-label">Ville<span class="red-star"> *</span>:</label><br>
        ...
        <div class="mb-3">
            <label for="role" class="form-label">Rôle<span class="red-star"> *</span>:</label><br>
